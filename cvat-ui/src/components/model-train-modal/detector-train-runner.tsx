...
interface Props {
    ...
    runTraining(model: Model, body: object): void;
}

function DetectorRunner(props: Props): JSX.Element {
    const {
        models, withCleanup, labels, dimension, runTraining,
    } = props;
    ...
    return (
        <div className='cvat-train-model-content'>
            <Row align='middle'>
            ...
            <Row align='middle' justify='end'>
                <Col>
                    <Button
                        ...
                        type='primary'
                        onClick={() => {
                            runTraining(model, model.type === 'detector' ?
                                { mapping, cleanup } : {
                                    threshold,
